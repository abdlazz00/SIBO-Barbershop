...
export default function Transactions({ transactions = [], filters = {} }) {
    ...
    const applyFilters = () => {
        router.get(route('cashier.transactions.index'), {
            search,
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-on-light-muted mt-1">
                            Kelola dan tinjau seluruh transaksi pembayaran di cabang Anda.
                        </p>
                    </div>
                </div>
            }
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-hairline-cloud text-sm text-ink-deep font-medium">
                                {transactions.length === 0 ? (
                                    <tr>
                                        <td colSpan="9" className="text-center py-12 text-on-light-faint font-medium">
                                    ...
                                    transactions.map((tx) => (
                                        <tr key={tx.id} className="hover:bg-[#f8f7ff]/20 transition duration-150">
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <Link
                                                    href={route('cashier.transactions.receipt', tx.uuid)}
