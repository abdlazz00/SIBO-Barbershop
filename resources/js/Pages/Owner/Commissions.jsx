...
export default function Commissions({ branches = [], barbers = [], records = [], totals, filters }) {
                                    ...
                                    {records.length > 0 ? (
                                        records.map((r) => (
                                            <tr key={r.id} className="hover:bg-surface-card/40 transition">
                                                ...
                                                <td className="py-4 px-6 text-on-light-muted text-xs">{r.branch_name}</td>
                                        ...
                                        <tr>
                                            <td colSpan="8" className="py-12 text-center text-on-light-muted italic">
